...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$message = '<p>To reset your password, please <a href="'.BASE_URL.'reset-password.php?email='.$_POST['agent_email'].'&token='.$token.'">click here</a> and enter a new password for your account';
