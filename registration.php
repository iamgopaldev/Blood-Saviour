...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_agent (agent_name,agent_designation,agent_organization,agent_email,agent_phone,agent_address, agent_city,agent_state,agent_country,agent_zip_code,agent_password,agent_token,agent_time,agent_access,agent_blood_group) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
		$statement->execute(array($_POST['agent_name'],$_POST['agent_designation'],$_POST['agent_organization'],$_POST['agent_email'],$_POST['agent_phone'],$_POST['agent_address'],$_POST['agent_city'],$_POST['agent_state'],$_POST['agent_country'],$_POST['agent_zip_code'],md5($_POST['agent_password']),$token,$now,0,$_POST['agent_blood_group_id']));
...
<div class="login-area bg-area" style="background-color:#ffefff;">
	<div class="container">
		<div class="row">
