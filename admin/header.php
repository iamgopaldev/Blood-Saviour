	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg" >Blood Bank System</span>
			</a>
			...
			<nav class="navbar navbar-static-top" style="background-color:grey;">
				...
				<span style="float:left;line-height:30px;color:ghostwhite;padding-left:15px;font-size:18px;">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($cur_page == 'agent.php') || ($cur_page == 'agent-payment.php') ) {echo 'active';} ?>">
						...
						<ul class="treeview-menu">
							<li><a href="agent.php"><i class="fa fa-circle-o"></i> All Users</a></li>
						</ul>
					</li>		
					...
					<li class="treeview <?php if( ($cur_page == 'request-pending.php')||($cur_page == 'request-approved.php') ) {echo 'active';} ?>">
						<a href="#">
							<i class="fa fa-hand-o-right"></i>
							<span>Blood Requests Section</span>
							<span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
						<ul class="treeview-menu">
							<li><a href="request-pending.php"><i class="fa fa-circle-o"></i> Pending Requests</a></li>
							<li><a href="request-approved.php"><i class="fa fa-circle-o"></i> Approved Requests</a></li>
						</ul>
					</li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'pricing-plan-add.php')||($cur_page == 'pricing-plan.php')||($cur_page == 'pricing-plan-edit.php') ) {echo 'active';} ?>">
			          <a href="callbacks.php">
			            <i class="fa fa-hand-o-right"></i> <span>Callbacks</span>
			          </a>
			        </li>
