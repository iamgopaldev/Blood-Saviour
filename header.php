...
if($mod_rewrite == 'Off') {
	...
	define("URL_REQUEST_BLOOD", "request-blood.php");
	define("URL_REQUESTS_VIEW", "requests-view.php");
	...
	define("URL_REQUEST_EDIT", "request-edit.php?id=" );
	define("URL_REQUEST_DELETE", "request-delete.php?id=" );
} else {
	...
	define("URL_REQUEST_BLOOD", "request-blood");
	define("URL_REQUESTS_VIEW", "requests-view");
	define("URL_DONOR_VIEW", "donor-view");
	define("URL_PROFILE_EDIT", "profile-edit");
	define("URL_PROFILE_PHOTO_EDIT", "profile-photo-edit");
	define("URL_REQUEST_EDIT", "request-edit/" );
	define("URL_REQUEST_DELETE", "request-delete/" );
}
...
s1.async=true;
s1.src='https://embed.tawk.to/6069b6f3067c2605c0bf21e0/1f2ef5arf';
s1.charset='UTF-8';
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="top-header-right">
						...
						<?php if(!isset($_SESSION['agent'])): ?>
							<a href="<?php echo BASE_URL.URL_LOGIN; ?>"><i class="fa fa-sign-in"></i>LogIn</a>
						<?php else: ?>
