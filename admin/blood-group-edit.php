...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("UPDATE tbl_blood_group SET blood_group_name=?, stock=? WHERE blood_group_id=?");
		$statement->execute(array($_POST['blood_group_name'],$_POST['blood_quantity'],$_REQUEST['id']));
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<label for="" class="col-sm-2 control-label">Available Quantity <span>*</span></label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="blood_quantity" value="<?php echo $stock; ?>" autocomplete="off">
							</div>
						</div>
						<div class="form-group">
