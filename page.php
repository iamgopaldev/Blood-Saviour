...
<div class="faq-area bg-area" style="background-color:#ffefff;">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
...
?>
<div class="contact-area bg-area" style="background-color:#ffefff;">
	<div class="container">
		<div class="row">
...
if(isset($_POST['form_contact']))
{
    ...
    if($valid == 1)
    {
        ...
        $statement = $pdo->prepare("INSERT INTO tbl_callbacks (name,email,phone,message) VALUES (?,?,?,?)");
        $statement->execute(array($visitor_name,$visitor_email,$visitor_phone,$visitor_comment));
		
        $success_message = "Call back request sent successfully.";
...
?>
				...
				<div class="contact-form" style="background-color:#ffefff;">
...
<div class="blog-page-area" style="background-color:#ffefff;">
	<div class="container">
		<div class="row">
...
<div class="testimonial-area testimonial-page" style="background-color:#ffefff;">
	<div class="container">
		<div class="row">
...
<div class="packages-area bg-area" style="background-color:#ffefff;">
	<div class="container">
		<div class="row">
...
<div class="donner-page-area" style="background-color:#ffefff;">
	<div class="container">
		<div class="row">
