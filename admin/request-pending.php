...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="request-approved.php" class="btn btn-primary btn-sm">Approved Requests</a>
	</div>
</section>
                ...
                foreach ($result as $row) {
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="#" class="btn btn-warning btn-xs" data-href="request-pending-action.php?id=<?php echo $row['request_id']; ?>" data-toggle="modal" data-target="#confirm-approve">Approve it</a>
                            </td>
                        </tr>
                    <?php
                }
